...
def parse_args(input_args=None):
    parser = argparse.ArgumentParser(description="Train a ControlNet.")
    parser.add_argument(
        "--pretrained_model_name_or_path",
        type=str,
        default=None,
    ...
    parser.add_argument(
        ...
        default=512,
        help=(
            "The resolution height for input images, all the images in the train/validation dataset will be resized to this"
            " resolution"
        ),
    )
    parser.add_argument(
        ...
        default=512,
        help=(
            "The resolution width for input images, all the images in the train/validation dataset will be resized to this"
            " resolution"
        ),
    )
    parser.add_argument(
